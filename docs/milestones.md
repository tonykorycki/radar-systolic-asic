...
**Team:** DSP Group · Accelerator Group · Integration Group · Verification & Backend Group
...
See [docs/architecture.md](architecture.md) for module descriptions, interface tables, register map, and repository structure.
